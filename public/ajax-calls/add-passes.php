...
foreach ($activeLoans as $i => $activeLoan) {
    ...
    if ($activeLoan['mode'] == 'Daily') {
        ...
        // echo 'this is active loans '. json_encode($activeLoans[$i]);
...
$todayPasses = [
    'daily_passes' => count($dailyPass),
    'weekly_passes'=> count($weeklyPass),
];

echo json_encode($todayPasses);
