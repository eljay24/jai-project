  ...
  <div class="jai-table table-container">
    ...
    ?>
      ...
      <div data-row-id="<?php echo $mode_data['l_id'] ?>" class="row jai-data-row">
        ...
        <!-- <div class="col">
          <div class="row">
            <p class="primary-font <?php //echo ((float)$mode_data['payment_yesterday'] < (float)$mode_data['mode'] ? 'red-font' : 'green-font')  ?>"><?php //echo $mode_data['payment_yesterday'] == 0 ? 'PASS' : '₱' . $mode_data['payment_yesterday']  ?></p>
          </div>
        </div> -->
      </div>
    <?php $count++;
